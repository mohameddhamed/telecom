# lottery_client_tcp_random.py
import sys
import socket
import random

# --- Solves Task I.a (TCP) + Task II.a (bytes with ':') + Task IV.a (random numbers) ---
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python3 lottery_client_tcp_random.py <server_ip> <server_port>")
        sys.exit(1)
